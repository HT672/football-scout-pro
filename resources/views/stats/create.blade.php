...
@section('title', 'Add Player Statistics')
...
<div class="container">
    <div class="mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Player Statistics</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-header bg-light">
            <h5 class="mb-0">Add Player Statistics</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('stats.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('player_id') is-invalid @enderror" id="player_id" name="player_id" required>
                            ...
                            @foreach($players as $id => $name)
                                <option value="{{ $id }}" {{ old('player_id', request('player_id')) == $id ? 'selected' : '' }}>{{ $name }}</option>
                            @endforeach
                        </select>
                        @error('player_id')
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('match_id') is-invalid @enderror" id="match_id" name="match_id">
                            ...
                            <!-- Dynamic options will be loaded via JavaScript -->
                        </select>
                        @error('match_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('season') is-invalid @enderror" id="season" name="season" value="{{ old('season', '2024-2025') }}" required>
                        @error('season')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('minutes_played') is-invalid @enderror" id="minutes_played" name="minutes_played" value="{{ old('minutes_played', 0) }}" min="0" max="120" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control @error('goals') is-invalid @enderror" id="goals" name="goals" value="{{ old('goals', 0) }}" min="0" required>
                        @error('goals')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control @error('assists') is-invalid @enderror" id="assists" name="assists" value="{{ old('assists', 0) }}" min="0" required>
                        @error('assists')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control @error('yellow_cards') is-invalid @enderror" id="yellow_cards" name="yellow_cards" value="{{ old('yellow_cards', 0) }}" min="0" required>
                        @error('yellow_cards')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control @error('red_cards') is-invalid @enderror" id="red_cards" name="red_cards" value="{{ old('red_cards', 0) }}" min="0" required>
                        @error('red_cards')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('passes') is-invalid @enderror" id="passes" name="passes" value="{{ old('passes', 0) }}" min="0" required>
                        @error('passes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('pass_accuracy') is-invalid @enderror" id="pass_accuracy" name="pass_accuracy" value="{{ old('pass_accuracy', 0) }}" min="0" max="100" step="0.1">
                        @error('pass_accuracy')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('shots') is-invalid @enderror" id="shots" name="shots" value="{{ old('shots', 0) }}" min="0" required>
                        @error('shots')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('shots_on_target') is-invalid @enderror" id="shots_on_target" name="shots_on_target" value="{{ old('shots_on_target', 0) }}" min="0" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('tackles') is-invalid @enderror" id="tackles" name="tackles" value="{{ old('tackles', 0) }}" min="0" required>
                        @error('tackles')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('interceptions') is-invalid @enderror" id="interceptions" name="interceptions" value="{{ old('interceptions', 0) }}" min="0" required>
                        @error('interceptions')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('saves') is-invalid @enderror" id="saves" name="saves" value="{{ old('saves', 0) }}" min="0">
                        @error('saves')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('clean_sheets') is-invalid @enderror" id="clean_sheets" name="clean_sheets" value="{{ old('clean_sheets', 0) }}" min="0">
                        @error('clean_sheets')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Trigger change event if player is pre-selected
        if (playerIdSelect.value) {
            const event = new Event('change');
            playerIdSelect.dispatchEvent(event);
        }
    });
</script>
@endsection